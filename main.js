...
function InfoVerifc(pais){
    if (pais == 'Egipto'){
        return `
            ...
            El área del antiguo Egipto ha variado a lo largo de los siglos, pero en general se acepta que abarcaba desde el delta del Nilo en el norte, hasta Elefantina, en la primera catarata del Nilo, en el sur. Además controlaba el desierto oriental, la línea costera del mar Rojo, la península del Sinaí, y un gran territorio 
            ...
            Egipto está situado en el noreste de África y está muy aislado de otros países por su situación geográfica. Sus límites son: por el oeste el desierto de Libia; por el este, el Mar Rojo y el desierto de Arabia; por el norte el mar Mediterráneo y por el sur el macizo de Etiopía y el desierto de Nubia. Ese medio natural circundante limitaba los contactos con el exterior, 
            ...
            Egipto es un país con una gran extensión de desierto y esto se nota en algunas de sus costumbres culinarias (como la frugalidad de sus platos). No obstante al ser un país musulmán muchas de las costumbres gastronómicas están regidas por las leyes del Islam.</p>
            <h2>Literatura</h2>
        ...
        los territorios de ultramar incluyen la Guayana Francesa en América del Sur, San Pedro y Miquelón en el Atlántico Norte, las Antillas francesas y muchas islas en Oceanía y el océano Índico. Debido a sus diversos territorios costeros, Francia posee la mayor zona económica exclusiva del mundo. Francia limita con Bélgica, Luxemburgo, Alemania, Suiza, Mónaco, Italia, Andorra y España en Europa, así como con los Países Bajos, Surinam y Brasil en América. 
        ...
        <h2>Ubicacion Geografica</h2>
        <p> es un estado transcontinental, formado por una parte metropolitana (esta, ubicada en Europa occidental) y una serie de departamentos de ultramar repartidos entre África, y América. 
        ...
        El primer ministro Jean-Baptiste Colbert fundó en 1648 la Real Academia de Pintura y Escultura bajo el mandato de Luis XIV para proteger a estos artistas; en 1666 también creó la todavía activa Academia Francesa de Roma para tener relaciones directas con los artistas italianos.
        ...
        return `
        <h1>Alemania</h1>
        <p>es uno de los veintisiete Estados soberanos que forman la Unión Europea. Constituido en Estado social y democrático de derecho, su forma de gobierno es la república parlamentaria y federal. Su capital es Berlín. Está formado por dieciséis estados federados (Bundesländer) y limita al norte con el mar del Norte, Dinamarca, Suecia (frontera marítima) y el mar Báltico; al este con Polonia y la República Checa; al sur con Austria y Suiza; y al oeste con Francia, Luxemburgo, Bélgica y los Países Bajos. El municipio Büsingen am Hochrhein, enclavado en Suiza, también forma parte de Alemania. El territorio de Alemania abarca 357 376 km² de extensión y posee un clima templado. Con más de 84 millones de habitantes, es el país más poblado entre los Estados de la Unión Europea, y es el hogar del tercer mayor grupo de emigrantes internacionales. En 2014 Alemania fue el segundo destino de las migraciones más popular del mundo, después de Estados Unidos</p>
        <h2>Ubicacion Geografica</h2>
        ...
        <h2>Arte</h2>
        <p>Australia cuenta con más de 100 000 yacimientos de arte rupestre aborigen, y los diseños, patrones e historias tradicionales impregnan el arte indígena australiano contemporáneo, «el último gran movimiento artístico del siglo xx», según el crítico Robert Hughes;entre sus exponentes se encuentra Emily Kame Kngwarreye. Los primeros artistas coloniales mostraron una fascinación por la tierra desconocida. Las obras impresionistas de Arthur Streeton, Tom Roberts y otros miembros de la escuela de Heidelberg del siglo xix el primer movimiento «claramente australiano» en el arte occidental expresaron los sentimientos nacionalistas en el período previo a la federación. Aunque la escuela siguió siendo influyente en la década de 1900, modernistas como Margaret Preston y, más tarde, Sidney Nolan, exploraron nuevas tendencias artísticas. El paisaje siguió siendo fundamental en la obra del acuarelista aborigen Albert Namatjira, así como en la de Fred Williams, Brett Whiteley y otros artistas de la posguerra cuyas obras, de estilo ecléctico pero singularmente australiano, se movían entre lo figurativo y lo abstracto</p>
        <h2>Gastronomia</h2>
